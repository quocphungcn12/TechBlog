...
export class AdminApiPostApiClient {
     ...
     * @return Success
     */
    getReson(id: string): Observable<string> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetReson(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetReson(response_ as any);
                } catch (e) {
    ...
    protected processGetReson(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiPostCategoryApiClient {
     ...
     * @return Success
     */
    deletePostCategory(body?: string[] | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/PostCategory";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getAllPostCategory(): Observable<PostCategoryDto[]> {
        let url_ = this.baseUrl + "/api/admin/PostCategory";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllPostCategory(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllPostCategory(response_ as any);
                } catch (e) {
    ...
    protected processGetAllPostCategory(response: HttpResponseBase): Observable<PostCategoryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiRoyaltyApiClient {
    ...
    getTransactionHistory(keyword?: string | null | undefined, fromMonth?: number | undefined, fromYear?: number | undefined, toMonth?: number | undefined, toYear?: number | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<TransactionDtoPagedResult> {
        let url_ = this.baseUrl + "/api/Royalty/transaction-histories?";
        if (keyword !== undefined && keyword !== null)
            url_ += "keyword=" + encodeURIComponent("" + keyword) + "&";
        if (fromMonth === null)
    ...
    getRoyaltyReportByUser(userId?: string | null | undefined, fromMonth?: number | undefined, fromYear?: number | undefined, toMonth?: number | undefined, toYear?: number | undefined): Observable<RoyaltyReportByUserDto[]> {
        let url_ = this.baseUrl + "/api/Royalty/Royalty-report-by-user?";
    ...
    getRoyaltyReportByMonth(userId?: string | null | undefined, fromMonth?: number | undefined, fromYear?: number | undefined, toMonth?: number | undefined, toYear?: number | undefined): Observable<RoyaltyReportByMonthDto[]> {
        let url_ = this.baseUrl + "/api/Royalty/Royalty-report-by-month?";
        if (userId !== undefined && userId !== null)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        if (fromMonth === null)
            throw new Error("The parameter 'fromMonth' cannot be null.");
    ...
    payRoyalty(userId: string): Observable<void> {
        let url_ = this.baseUrl + "/api/Royalty/{userId}";
        if (userId === undefined || userId === null)
...
export class PostCategoryDtoPagedResult implements IPostCategoryDtoPagedResult {
    ...
    pageCount?: number;
    result?: PostCategoryDto[] | undefined;
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["result"])) {
                ...
                for (let item of _data["result"])
                    this.result!.push(PostCategoryDto.fromJS(item));
            }
        }
    }
...
export class PostInListDtoPagedResult implements IPostInListDtoPagedResult {
    ...
    additionalData?: string | undefined;
    pageCount?: number;
    result?: PostInListDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["result"])) {
                this.result = [] as any;
                for (let item of _data["result"])
                    this.result!.push(PostInListDto.fromJS(item));
            }
        }
    }
...
export class SeriesInListDtoPagedResult implements ISeriesInListDtoPagedResult {
    ...
    additionalData?: string | undefined;
    pageCount?: number;
    result?: SeriesInListDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["result"])) {
                this.result = [] as any;
                for (let item of _data["result"])
                    this.result!.push(SeriesInListDto.fromJS(item));
            }
        }
    }
...
export class TransactionDtoPagedResult implements ITransactionDtoPagedResult {
    ...
    additionalData?: string | undefined;
    pageCount?: number;
    result?: TransactionDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["result"])) {
                this.result = [] as any;
                for (let item of _data["result"])
                    this.result!.push(TransactionDto.fromJS(item));
            }
        }
    }
